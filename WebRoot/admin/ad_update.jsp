...
<body>
	<div id="contentWrap">
		...
		<div style="border: 1px solid #bfd9e1; padding: 20px 20px;">
			<h3>------修改广告或者活动------</h3>
			<form action="${ctx }/ad/updated" method="post" enctype="multipart/form-data">
				<input type="hidden" name="aid" value="${ad.aid }">
				<input type="hidden" name="adimg" value="${ad.adimg }">
				<table style="width: 600px;">
					<tr style="line-height: 30px;">
						<td style="width: 70px;">标题:</td>
						<td><textarea   name="title" class="border"
							maxlength="100" required="required"  style="width: 250px;">${ad.title }</textarea></td>
					...
					<tr>
						<td colspan="3"><img id="file_adimg" src="${imgctx }${ad.adimg}" style="width: 100%;"></td>
					</tr>
					<tr style="line-height: 30px;">
						<td style="width:70px;">链接url:</td>
						<td><input type="text" name="link" class="border" value="${ad.link }"
					...
					<tr style="line-height: 30px;">
						...
						<td><textarea  name="note"  class="border"
							maxlength="200" style="width: 250px;">${ad.note }</textarea></td>
						<td style="color: red">可选，200字以内</td>
					</tr> 
					<tr style="line-height: 30px;">
						<td style="width: 70px;">排序字段:</td>
						<td><input type="number" name="asort" value=${ad.asort } class="border"
